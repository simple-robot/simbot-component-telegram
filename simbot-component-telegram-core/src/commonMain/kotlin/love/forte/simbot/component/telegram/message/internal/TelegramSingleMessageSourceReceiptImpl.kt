...
import love.forte.simbot.component.telegram.message.*
 ...
 * (preferably >= 2).
 */
internal fun List<Message>.toTelegramMessageReceipt(bot: TelegramBotImpl, chatId: Long = first().chat.id): TelegramAggregatedMessageSourceReceiptImpl {
